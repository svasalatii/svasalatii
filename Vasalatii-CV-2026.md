...
- Phone: +380 63 209 69 69
- Email: svasalatii@gmail.com
...
* *Authoring tools (Paligo, Gitbook)*
* *Docs-as-code (Git, Markdown, Asciidoc, MkDocs)*
* *CAT-tools (SDL Trados, MemoQ, Atril Déjà Vu X)*
* *Screen capturing and editing tools (SnagIt, MonoSnap)*

### Writing skills:

- *Technical Documentation*: Drafting, editing, and publishing user manuals, installation guides, FAQs, and product specifications.
- *Process & Policy Writing*: Creating clear standard operating procedures (SOPs), compliance policies, incidents/emergency response instructions, and workflow procedures.
- *Content Structuring*: Organizing information into logical formats for knowledge bases, Confluence spaces, Gitbook documentation, and Markdown repositories.
- *Editing & Proofreading*: Ensuring clarity, consistency, and grammar accuracy across release notes, internal reports, and client‑facing documents.
- *Summarization*: Translating complex material into concise meeting minutes, executive summaries, and project briefs.
- *Publishing Prep*: Converting drafts into final formats such as PDFs, DOCX deliverables, and Gitbook‑ready Markdown files.
- *Collaboration*: Working with PMs, QAs, and developers to refine drafts of feature descriptions, test case documentation, and project plans.

<div style="page-break-after: always;"></div>

### Experience:

#### February 2022 – July 2026, [Gemshelf Inc](https://shelf.io/).
...
* *migrated key customer-facing guides/documents to the Company's Gitbook-based documentation portal, using Github VCS and Markdown*
* *assisted Customer Support, Design, Product depts with analyzing and implementing best UI/UX copy for the company's products*
* *kept track of change releases and participated in various planning and feature overview meetings to be able to update the relevant documents in proper time in line with the software release plans.*


#### April 2021 – January 2022, 	[EDETEK Inc](https://edetek.com/).
...
* *performed other tasks as instructed by PMs*
